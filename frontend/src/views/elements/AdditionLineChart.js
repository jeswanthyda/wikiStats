...
class AdditionLineChart extends React.Component {
    values = {
        data: {
      ...
      componentDidMount(){
        ...
        this.eventSource = new EventSource(NodeConnector["endpoint"] + `additionLineChart`);
...
export default AdditionLineChart;